...
import com.cg.training.BootTransactionApplication;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer updateCustomer(CustomerUpdateWrapper req,String newName) throws JsonGenerationException, JsonMappingException, IOException {
		...
		try {
			...
			sendData =	CustomerServiceImpl.fromJavaToJson(audit);
			
			rabbitTemplate.convertAndSend(BootTransactionApplication.MESSAGE_QUEUE, sendData);
